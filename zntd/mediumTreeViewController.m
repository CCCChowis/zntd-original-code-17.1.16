...
#import "mediumTreeViewController.h"
#import "TWLAlertView.h"

@interface mediumTreeViewController()
@property(nonatomic)NSInteger keys;
@end

@implementation mediumTreeViewController
...
//    UIViewController *homeview = [storyboard instantiateViewControllerWithIdentifier:@"view1"];
